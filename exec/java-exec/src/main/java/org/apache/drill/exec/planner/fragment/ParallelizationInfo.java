...
public class ParallelizationInfo {
  ...
  public static final ParallelizationInfo DEFAULT = ParallelizationInfo.create(1, Integer.MAX_VALUE);

  /* Single width parallelization with no endpoint affinity map. */
  public static final ParallelizationInfo SINGLE_INSTANCE = ParallelizationInfo.create(1, 1);
