...
public class PhysicalOperatorUtil {
  ...
  /**
   * Helper method to create a list of MinorFragmentEndpoints for a given endpoints assignments of opposite major
   * fragment.
   *
   * @param endpoints This list should be index-ordered the same as the expected minorFragmentIds for each sender.
   * @return
   */
