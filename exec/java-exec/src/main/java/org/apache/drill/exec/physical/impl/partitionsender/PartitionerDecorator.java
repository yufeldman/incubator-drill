...
public class PartitionerDecorator {
   ...
   * @throws IOException
   */
  private void executeMethodLogic(final GeneralExecuteIface iface) throws IOException {
    if (partitioners.size() == 1 ) {
      ...
      try {
        ...
        stats.adjustWaitNanos(partitioners.get(0).getStats().getWaitNanos());
      }
      return;
    }
   ...
   *
   */
  private interface GeneralExecuteIface {
